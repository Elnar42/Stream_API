...
public class Employee {
    ...
    public Employee saveWithNewSalary(double newSalary) {
        return new Employee(this.id, this.name, this.surname, this.age, newSalary, this.department, this.isEmployer, this.startDate, this.email, this.phoneNumber, this.position, this.address);
    }
